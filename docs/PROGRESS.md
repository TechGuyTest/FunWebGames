...
| # | Title | Labels | Status |
|---|-------|--------|--------|
| 17 | Add LocalStorage High Score System to Games | enhancement, in-progress | In progress |
| 21 | Add Help/Tutorial Modals to All Games | enhancement, in-progress | In progress |
| 22 | Add Sound Effects Toggle to All Games | enhancement, in-progress | In progress |
...
- Issue #17: Add LocalStorage High Score System (enhancement, in-progress)
...
- Issue #21: Add Help/Tutorial Modals (enhancement, in-progress)
- Issue #22: Add Sound Effects Toggle (enhancement, in-progress)
- Issue #23: Add Offline PWA Support (enhancement, in-progress)
